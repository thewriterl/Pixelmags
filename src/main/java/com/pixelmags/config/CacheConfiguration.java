...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.pixelmags.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.pixelmags.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, com.pixelmags.domain.PersistentToken.class.getName());
            createCache(cm, com.pixelmags.domain.User.class.getName() + ".persistentTokens");
